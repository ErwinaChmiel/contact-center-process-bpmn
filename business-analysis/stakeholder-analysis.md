...
- liczba spraw przekroczonych po SLA.

---

## Podsumowanie interesariuszy

| Interesariusz | Główna potrzeba | Wartość biznesowa |
|---|---|---|
| Klient | szybka obsługa sprawy | wyższa satysfakcja |
| Konsultant | pełna informacja o kliencie | krótszy czas obsługi |
| Lider zespołu | kontrola KPI | szybsza reakcja na problemy |
| Menedżer | raportowanie i optymalizacja | decyzje oparte na danych |
EOF
